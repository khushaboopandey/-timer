...
export const TimerItem: React.FC<TimerItemProps> = ({ timer }) => {
  const { toggleTimer, deleteTimer, updateTimer, restartTimer, editTimer } =
    useTimerStore();
  ...
  const handleRestart = () => {
    ...
    restartTimer(timer.id); // Resets the timer
    console.log("Timer restarted:", timer.id);
  };
  ...
  return (
    <>
      ...
      <TimerModal
        ...
        onSubmit={(updatedTimerData) => {
          editTimer(timer.id, updatedTimerData);
